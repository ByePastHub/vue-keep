...
function historyJumpExtend(router) {
  ...
  function buildState(position, method) {
    ...
    var current = (['forward', 'pushState'].includes(method) ? historyStack[position - 1] : historyStack[position]) || path;
    return {
  ...
  function routerBeforeCallback(method, toLocation) {
    ...
    var isBack = method === 'back' || ((_toLocation = toLocation) === null || _toLocation === void 0 ? void 0 : _toLocation.delta) < 0;
